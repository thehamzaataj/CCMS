                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} md={3} lg={3}>
                        <StyledPaper>
                            ...
                            <Data start={0} end={cgpa} duration={2.5} decimals={2} />
                        </StyledPaper>
                    </Grid>
                    <Grid item xs={12} md={3} lg={3}>
                        <StyledPaper>
                            <img src={Subject} alt="School" />
                            <Title>
                                Department
                            </Title>
                            <TextData>
                    ...
                    <Grid item xs={12}>
                        <Paper sx={{ p: 2, display: 'flex', flexDirection: 'column' }}>
                            <Typography variant="h6" sx={{ mb: 2 }}>Subject Details</Typography>
                            <TableContainer>
                                <Table>
                                    <TableHead>
                                        <TableRow>
                                    ...
                                    <TableBody>
                                        {subjectsList && subjectsList.map((subject, index) => {
                                            const attendance = subjectAttendance.find(
                                                (att) => att.subjectName === subject.subName
                                            );
                                            return (
                                                <TableRow key={index}>
                                                    ...
                                                    <TableCell>
                                                        {attendance ? attendance.grade : 'N/A'}
                                                    </TableCell>
                                                </TableRow>
                                            );
                                        })}
